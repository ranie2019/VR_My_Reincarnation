...
public class EsperitoDeFogoIA : MonoBehaviour
{
    ...
    [Header("Combate")]
    [Tooltip("Dist�ncia em que o Esp�rito para de correr e come�a a atacar")]
    ...
    [Header("Refer�ncias")]
    [SerializeField] private EsperitoDeFogoAnimacao animacao; // Voc� pode criar depois
